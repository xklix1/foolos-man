# فلوس مان تايكون | Foolos Man Tycoon

محاكي اقتصادي واستثماري متكامل باللغة العربية مع دعم كامل للاتجاه من اليمين لليسار (RTL) وتزامن حي مع قاعدة البيانات السحابية (Firebase Firestore) أو العمل في وضع المحاكاة المحلي.
